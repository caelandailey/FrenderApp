...
/// Keeps logging into google on login view. Why? 
/// Get google button to work on login view
/// Switch some methods from here to login view controller? 
/// Google button fix
...
class AppDelegate: UIResponder, UIApplicationDelegate, GIDSignInDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        FBSDKSettings.setAppID("469046853445530") // App ID for facebook login
        ...
        {
            goToMainView()
            print("Current user, skipped login view")
            return true
        }
    ...
    // WHEN LOGIN RETURNS TO APP VIEW
    @available(iOS 9.0, *)
    func application(_ application: UIApplication, open url: URL, options: [UIApplicationOpenURLOptionsKey : Any])
        -> Bool {
            
            if (url.scheme! == "fb469046853445530")
            {
            ...
            {
                print("Returned from Google Login")
